...
int send_play(Game *g){
    ...
    char board[50]; // enough for "1 3 5 7 9"
    ...
    int r1 = format_message(g->p1->fd, msg);
    int r2 = format_message(g->p2->fd, msg);
...
int send_play_single(Player *p, Game *g){
    ...
    return format_message(p->fd, msg);
}
